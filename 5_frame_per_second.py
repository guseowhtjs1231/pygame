...
# 배경 이미지 불러오기
background = pygame.image.load("/users/youngbinha/desktop/python/pygame/background.png")

# 캐릭터 (스프라이트) 불러오기
character = pygame.image.load("/users/youngbinha/desktop/python/pygame/character.png")
